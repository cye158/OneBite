package apiHelpers.SQLiteDatabase;
...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public static final String COLUME_NAME = "_name";
    public static final String COLUME_LATITUDE = "_latitude";
    public static final String COLUME_LONGITUDE = "_longitude";
    ...
    public String databaseToString() {
        ...
        while (!cursor.isAfterLast()) {
            if (cursor.getString(cursor.getColumnIndex("visitedPlace"))!= null) {
                dbString += cursor.getString(cursor.getColumnIndex("visitedPlace"));
                dbString += "\n";
            }
        }
