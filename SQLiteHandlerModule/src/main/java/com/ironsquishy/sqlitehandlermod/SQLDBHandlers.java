...
public class SQLDBHandlers extends SQLiteOpenHelper {
    ...
    private static EnrtyField mEntry;
    ...
    {
      entry = new EntryField(pRestuarent, pLatitude, pLongitude);
    ...
    /**
    * @author Allen Space
    * @param entry Entry obect.
    * @return String array.
    */
    public string[] getEntryByObject(Entry entry)
    {
      Sting dbstring = "";
      SQLiteDabase db = getWritableDatabase();
